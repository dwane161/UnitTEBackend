...
namespace CustomerApi.Services.CustomerService
{
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<List<Customer>> GetCustomersByNameAsync(string searchTerm)
        {
            ...
            {
                customers = await _customerDbContext.Customers.ToListAsync();
            }
        ...
        public async Task<Customer> UpdateCustomerAsync(int id, Customer customer)
        {
            ...
            searchResult.Genre = customer.Genre;
            searchResult.Email = customer.Email;
            searchResult.ContactNumbers = customer.ContactNumbers;
